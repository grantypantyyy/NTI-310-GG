...
$config->custom->session['blowfish'] = '9ba47e7fd1ddb302c31db308b791ed9d';  # Autogenerated for ldap-server
...
$servers->setValue('server','name','grantypantyyy LDAP Server');
...
$servers->setValue('server','base',array('dc=grant,dc=local'));
...
$servers->setValue('login','bind_id','cn=ldapadm,dc=grant,dc=local');
